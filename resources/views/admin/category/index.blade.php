    ...
    <div class="right-header-wp">
        <div class="right-header">
            ...
            <div class="right-h pull-right">
                ...
                <a class="btn-add" href="{{route('admin.categories.create')}}">Thêm</a>
            </div>
        </div>
    </div>
                ...
                <table id="dataTable-new" class="my-table table table-bordered table-condensed table-hover table-striped responsive " width="100%" >
                    <thead>
                        <tr>
                            ...
                            <td class="text-center">Icon <span class="fa fa-caret-up"></span><span class="fa fa-caret-down"></span></td>
                    ...
                    <?php $i = 1;foreach($list as $item){ ?>
                        <tr>
                            <td><?=$i?></td>
                            <td class="text-center"><a href="{{ asset('/admin/categories/'.$item->id.'/edit') }}" target="_blank">{{ $item->name }}</a></td>
                            <td class="text-center"><img src="{{$item->img}}" alt="" style="width: 150px"></td>
                            <td class="text-center" style="min-width: 100px">
                                <a  href="{{ asset('/admin/categories/'.$item->id.'/edit') }}" class="btn btn-xs btn-info" target="_blank">Sửa</a>
